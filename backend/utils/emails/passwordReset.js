...
export const sendPasswordResetEmail = async (user, resetToken, resetPasswordURL) => {
    ...
    html: `
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Hello, ${user.name}</p>
                    <p>You have requested to reset your password for your Storefleet account. To reset your password, enter this token to complete the reset: ${resetToken}. please click the button below:</p>
